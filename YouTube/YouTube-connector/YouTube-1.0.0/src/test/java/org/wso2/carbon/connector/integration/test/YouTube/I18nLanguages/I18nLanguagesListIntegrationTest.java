...
public class I18nLanguagesListIntegrationTest extends ESBIntegrationTest {
    ...
    @Test(enabled=false, groups = {"wso2.esb"}, description = "YouTube{getI18nLanguagesWithValidMandatoryParameters} " +
            "integration test.")
    public void testGetI18nLanguagesWithValidMandatoryParameterParameters() throws Exception {
        String jsonRequestFilePath = pathToRequestsDirectory + "I18nLanguages/getI18nLanguagesMandatory.txt";
        String methodName = "getI18nLanguages";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + "I18nLanguages/" + methodName + ".xml";
        ...
        try {
            ...
            Assert.assertEquals("youtube#i18nLanguageListResponse", jsonObject.getString("kind"));
        } finally {
            proxyAdmin.deleteProxy(methodName);
        }
    }

    @Test(enabled=false, groups = {"wso2.esb"}, description = "YouTube{getI18nLanguagesWithInvalidMandatory} " +
            "integration test.")
    public void testGetI18nLanguagesWithInvalidMandatoryParameter() throws Exception {
        String jsonRequestFilePath = pathToRequestsDirectory + "I18nLanguages/getI18nLanguagesListInvalidMandatory.txt";
        String methodName = "getI18nLanguages";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + "I18nLanguages/" + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, YouTubeConnectorProperties.getProperty("apiUrl"),
    ...
    @Test(enabled=false, groups = {"wso2.esb"}, description = "YouTube{getI18nLanguagesWithInvalidOptional} " +
            "integration test.")
    public void testGetI18nLanguagesWithInvalidOptionalParameters() throws Exception {
        String jsonRequestFilePath = pathToRequestsDirectory + "I18nLanguages/getI18nLanguagesListInvalidOptional.txt";
        String methodName = "getI18nLanguages";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + "I18nLanguages/" + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, YouTubeConnectorProperties.getProperty("apiUrl"),
