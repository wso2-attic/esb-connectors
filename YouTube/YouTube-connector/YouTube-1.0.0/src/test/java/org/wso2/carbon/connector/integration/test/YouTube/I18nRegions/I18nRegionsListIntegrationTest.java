...
public class I18nRegionsListIntegrationTest extends ESBIntegrationTest {
    ...
    @Test(enabled=false, groups = {"wso2.esb"}, description = "YouTube{getI18nLanguagesWithValidMandatory} integration" +
            " test.")
    public void testGetI18nRegionsWithValidMandatoryParameter() throws Exception {
        String jsonRequestFilePath = pathToRequestsDirectory + "I18nRegions/getI18nRegionsMandatory.txt";
        String methodName = "getI18nRegions";
    ...
    @Test(enabled=true, groups = {"wso2.esb"}, description = "YouTube{getI18nLanguagesWithInvalidMandatory} " +
            "integration test.")
    public void testGetI18nRegionsWithInvalidMandatoryParameter() throws Exception {
        String jsonRequestFilePath = pathToRequestsDirectory + "I18nRegions/getI18nRegionsInvalidMandatory.txt";
        String methodName = "getI18nRegions";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + "I18nRegions/" + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, YouTubeConnectorProperties.getProperty("apiUrl"),
    ...
    @Test(enabled=false, groups = {"wso2.esb"}, description = "YouTube{getI18nRegionsWithInvalidOptional} integration " +
            "test.")
    public void testGetI18nRegionsWithInvalidOptionalParameter() throws Exception {
        String jsonRequestFilePath = pathToRequestsDirectory + "I18nRegions/getI18nRegionsInvalidOptional.txt";
        String methodName = "getI18nRegions";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + "I18nRegions/" + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, YouTubeConnectorProperties.getProperty("apiUrl"),
