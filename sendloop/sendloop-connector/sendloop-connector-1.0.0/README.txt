...
STEPS:
 ...
 5. Update the Sendloop properties file at location "<SENDLOOP_CONNECTOR_HOME>/sendloop-connector/sendloop-connector-2.0.0/org.wso2.carbon.connector/src/test/resources/artifacts/ESB/connector/config" as below.
	...
	xxiii)	subscriberListNameUpdated			- Updated name of the subscriber list.
	xxiv)	subscriberListOptInModeUpdated		- Mode of the subscriber list. Use 'Single'
	xxv)	mandatorySubscriberEmailAddress		- Email address of the subscriber. Use a properly formatted email address. E.g. subscriber.email.mandatory001@gmail.com
	xxvi)	optionalSubscriberEmailAddress		- Email address of the subscriber. Use a properly formatted email address. E.g. subscriber.email.optional001@gmail.com
	xxvii)	optionalSubscriptionIp				- IP address of the subscriber. Use a properly formatted IP address. E.g. 192.36.32.69
	xxviii)	subcriberEmailAddressUpdated		- Updated email address of the subscriber. Use a properly formatted email address. E.g. updated.email.mandatory001@gmail.com
	xxix)	clickedCampaignId					- ID of the campaign obtained in 4. v) g).
