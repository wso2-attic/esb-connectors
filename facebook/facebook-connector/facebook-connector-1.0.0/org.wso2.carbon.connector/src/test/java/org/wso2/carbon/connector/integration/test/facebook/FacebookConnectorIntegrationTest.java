...
public class FacebookConnectorIntegrationTest extends ConnectorIntegrationTestBase {
     ...
     */
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {getNoteDetails} integration test with mandatory parameters.")
     ...
     */
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {getNoteDetails} integration test with optional parameters.")
    ...
    public void testBanAppUserWithMandatoryParameters() throws IOException, JSONException {
        ...
        Assert.assertTrue(apiRestResponse.getBody().has("success"));
    ...
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {addMembersToFriendList} integration test with mandatory parameters.")
    ...
    @Test(enabled=false,priority = 1, groups = { "wso2.esb" }, dependsOnMethods = { "testAddMembersToFriendlistMandatoryParameters" }, description = "facebook {addMembersToFriendList} integration test negative case.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" },description = "facebook {getFriendListDetails} integration test with mandatory parameters.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" },description = "facebook {createAlbum} integration test with optional parameters.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {createAlbum} integration test negative case.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" },description = "facebook {getAlbumDetails} integration test with mandatory parameters.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {getAlbumDetails} integration test with optional parameters.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {getAlbumDetails} integration test negative case.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {getPost} integration test with mandatory parameters.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {deletePost} integration test negative case.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {deletePost} integration test with mandatory parameters.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {createPageOffer} integration test with optional parameters.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {getOfferDetails} integration test with mandatory parameters.")
    ...
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {getOfferDetails} integration test negative case.")
     ...
     */
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {getGroupDetails} integration test with mandatory parameters.")
     ...
     * @throws IOException, JSONException
     */
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {getGroupDetails} integration test with negative parameters.")
     ...
     * @throws IOException, JSONException
     */
    @Test(priority = 1, groups = { "wso2.esb" }, description = "facebook {getStatus} integration test with mandatory parameters.")
     ...
     * @throws IOException, JSONException
     */
    @Test(priority = 1, groups = { "wso2.esb" },  description = "facebook {getStatus} integration test with optional parameters.")
     ...
     */
    @Test(priority = 1, groups = { "wso2.esb" },description = "facebook {updateEventProfilePicture} integration test negative case.")
     ...
     * @throws InterruptedException
     */
    @Test(enabled=false,priority = 1, groups = { "wso2.esb" }, description = "facebook {postEventPhotos} integration test negative case.")
    ...
    /**testCreateFriendlistNegativeCase
