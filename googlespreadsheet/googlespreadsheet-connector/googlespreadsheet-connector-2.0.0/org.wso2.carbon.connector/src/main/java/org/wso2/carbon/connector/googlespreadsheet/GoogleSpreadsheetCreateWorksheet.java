...
public class GoogleSpreadsheetCreateWorksheet extends AbstractConnector {
    ...
    private QName qName = new QName("", "header");
	...
	public void connect(MessageContext messageContext) throws ConnectException {
		...
		try {
			...
			messageContext.getEnvelope().getBody().addChild(searchResult);
                ...
                ConnectException connectException = new ConnectException("Cannot create the worksheet. Spreadsheet with the given name is not available.");
