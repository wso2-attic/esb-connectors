    ...
    public void connect(MessageContext messageContext) throws ConnectException {
        try {
            ...
            if (ssEntry != null) {
                ...
                if (gssWorksheet.deleteWorksheet(worksheetName)) {
                    ...
                    ConnectException connectException = new ConnectException("Cannot delete the worksheet. Worksheet with the given name is not available.");
                    log.error("Error occured: " + connectException.getMessage(), connectException);
                    GoogleSpreadsheetUtils.storeErrorResponseStatus(messageContext, connectException);
                }
            } else {
                ConnectException connectException = new ConnectException("Cannot delete the worksheet. Spreadsheet with the given name is not available.");
                log.error("Error occured: " + connectException.getMessage(), connectException);
                GoogleSpreadsheetUtils.storeErrorResponseStatus(messageContext, connectException);
            }
