...
public class BasecrmConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    /**
     * Positive test case for setContacts method with mandatory parameters.
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateContactsNegativeCase" }, description = "BaseCRM {setContacts} integration test with mandatory parameters.")
    public void testSetContactsWithMandatoryParameters() throws Exception {
    
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_setContacts_mandatory.json",
                        parametersMap);
    ...
    /**
     * Positive test case for setContacts method with optional parameters.
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testSetContactsWithMandatoryParameters" }, description = "BaseCRM {setContacts} integration test with optional parameters.")
    public void testSetContactsWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_setContacts_optional.json",
                        parametersMap);
    ...
    /**
     * Negative test case for setContacts method.
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testSetContactsWithOptionalParameters" }, description = "BaseCRM {setContacts} integration test negative case.")
    public void testSetContactsNegativeCase() throws Exception {
    
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_setContacts_negative.json",
                        parametersMap);
        ...
        String apiEndPoint =
                salesApiEndpoint + "contacts/" + connectorProperties.getProperty("contactIdMandatory") + "Invalid"
                        + ".json";
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(apiEndPoint, "PUT", apiRequestHeadersMap, "api_setContacts_negative.json");
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testSetContactsNegativeCase" }, description = "BaseCRM {listContacts} integration test with mandatory parameters.")
    ...
    public void testCreateContactReminderWithMandatoryParameters() throws Exception {
        ...
        String apiEndPoint =
                salesApiEndpoint + "contacts/" + connectorProperties.getProperty("contactIdMandatory")
                        + "/reminders.json";
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    public void testCreateContactReminderWithOptionalParameters() throws Exception {
        ...
        String apiEndPoint =
                salesApiEndpoint + "contacts/" + connectorProperties.getProperty("contactIdOptional")
                        + "/reminders.json";
        RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
    ...
    public void testCreateDealWithMandatoryParameters() throws Exception {
        ...
        Assert.assertEquals(parametersMap.get("name"), apiRestResponse.getBody().getJSONObject("deal")
                .getString("name"));
    ...
    public void testCreateDealWithOptionalParameters() throws Exception {
        ...
        Assert.assertEquals(parametersMap.get("entityId"),
                apiRestResponse.getBody().getJSONObject("deal").getString("entity_id"));
        Assert.assertEquals(parametersMap.get("scope"),
                apiRestResponse.getBody().getJSONObject("deal").getString("scope"));
    ...
    /**
     * Positive test case for setDeals method with mandatory parameters.
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testGetContactDealsNegativeCase" }, description = "BaseCRM {setDeals} integration test with mandatory parameters.")
    public void testSetDealsWithMandatoryParameters() throws Exception {
    
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_setDeals_mandatory.json",
                        parametersMap);
        ...
        Assert.assertEquals(connectorProperties.getProperty("dealIdMandatory"), apiRestResponse.getBody()
                .getJSONObject("deal").getString("id"));
    }
    
    /**
     * Positive test case for setDeals method with optional parameters.
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testSetDealsWithMandatoryParameters" }, description = "BaseCRM {setDeals} integration test with optional parameters.")
    public void testSetDealsWithOptionalParameters() throws Exception {
    
        parametersMap.put("name", "Deal Name Updated");
        parametersMap.put("scope", "250");
        
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_setDeals_optional.json", parametersMap);
    ...
    /**
     * Negative test case for setDeals method.
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testSetDealsWithOptionalParameters" }, description = "BaseCRM {setDeals} integration test negative case.")
    public void testSetDealsNegativeCase() throws Exception {
    
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_setDeals_negative.json", parametersMap);
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testSetDealsNegativeCase" }, description = "BaseCRM {listDeals} integration test with mandatory parameters.")
    public void testListDealsWithMandatoryParameters() throws Exception {
        ...
        /*
         * List of deals are getting shuffled from request to request. Then first deal information of the
         * response is different from both ESB and API responses. Therefore we cannot do assertion on
         * information inside first deal.
         */
    ...
    public void testGetDealNotesNegativeCase() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getDealNotes_negative.json",
                        parametersMap);
    ...
    public void testCreateLeadWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createLead_mandatory.json",
                        parametersMap);
    ...
    public void testCreateLeadWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createLead_optional.json",
                        parametersMap);
        ...
        Assert.assertEquals(parametersMap.get("leadEmail"), apiRestResponse.getBody().getJSONObject("lead")
                .get("email"));
        Assert.assertEquals(parametersMap.get("leadTitle"), apiRestResponse.getBody().getJSONObject("lead")
                .get("title"));
    }
    ...
    public void testCreateLeadNegativeCase() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createLead_negative.json",
                        parametersMap);
    ...
    public void testListLeadsWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_listLeads_mandatory.json",
                        parametersMap);
        ...
        /*
         * List of leads are getting shuffled from request to request. Then first lead information of the
         * response is different from both ESB and API responses. Therefore we cannot do assertion on
         * information inside first lead.
         */
    ...
    public void testListLeadsWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_listLeads_optional.json",
                        parametersMap);
    ...
    public void testDeleteLeadWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_deleteLead_mandatory.json",
                        parametersMap);
    ...
    public void testDeleteLeadNegativeCase() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_deleteLead_negative.json",
                        parametersMap);
