...
package org.wso2.carbon.connector.interation.test.common;
...
public class ConnectorIntegrationUtil {
    ...
    public static final String ESB_CONFIG_LOCATION = "artifacts" + File.separator +
                                                     "ESB" + File.separator + "config";
