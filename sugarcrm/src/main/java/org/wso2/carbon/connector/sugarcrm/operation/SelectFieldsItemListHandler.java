...
/**
 * Class mediator which helps to modify the pay load for <strong>select_fields</strong> item list in SugarCRM
 * SOAP API.
 */
public class SelectFieldsItemListHandler extends AbstractConnector {
    ...
    public final void connect(final MessageContext messageContext) {
        ...
        Iterator< ? > omElementIterator = mainElement.getChildrenWithLocalName(SELECT_FIELDS_TAG);
