...
/**
 * Class mediator which helps to modify the pay load for <strong>name_value_lists</strong> item list in
 * SugarCRM SOAP API.
 */
public class NameValueItemListsHandler extends AbstractConnector {
    ...
    public final void connect(final MessageContext messageContext) {
        ...
        Iterator< ? > omElementIterator = mainElement.getChildrenWithLocalName(NAME_VALUE_LISTS_TAG);
