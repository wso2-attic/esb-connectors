...
/**
 * Class mediator which helps to modify the pay load for <strong>set_relationship_list</strong> method in
 * SugarCRM SOAP API.
 */
public class RelationshipItemListHandler extends AbstractConnector {
    ...
    public final void connect(final MessageContext messageContext) {
        ...
        Iterator< ? > omElementIterator = mainElement.getChildrenWithLocalName(SET_RELATIONSHIP_LIST_TAG);
        
        SugarCRMUtil.handleItemListElement(omElementIterator);
