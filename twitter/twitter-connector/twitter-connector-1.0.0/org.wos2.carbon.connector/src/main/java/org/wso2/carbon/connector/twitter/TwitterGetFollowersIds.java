...
public class TwitterGetFollowersIds extends AbstractTwitterConnector {

	private static Log log = LogFactory.getLog(TwitterGetFollowersIds.class);
	 ...
	 * @throws IOException
	 */
	private OMElement performSearchMessages(long[] ids) throws XMLStreamException,
