...
/**
 * This class performs the "read mail thread" operation.
 */
public class GmailReadMailThread extends AbstractConnector {

	/*
	 * Reads the thread ID from the message context and reads the belonging
	 * e-mail thread.
	 */
	@Override
	public void connect(MessageContext messageContext) {
		try {
			...
			GmailUtils.readMails(messageContext, store, term, "gmailReadMailThreadResponse");
			log.info("Successfully completed the \"read mail thread\" operation");
