...
public class EventbriteConnectorIntegrationTest extends ESBIntegrationTest {
    ...
    private String eventbriteConnectorFileName = CONNECTOR_NAME + ".zip";
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getuserdetails} integration test with mandatory parameters.")
    public void testGetUserDetailsWithMandatoryParameters() throws Exception {
        ...
        String modifiedJsonString = String.format(jsonString, eventbriteConnectorProperties.getProperty("accessToken"), eventbriteConnectorProperties.getProperty("userId"));
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getUserOrder} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getUserOwnedEvents} integration test with optinal parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getUserOwnedEventAttendees} integration test with optinal parameters.")
    ...
    public void testEventSearchWithOptinalParameters() throws Exception {
        ...
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, eventbriteConnectorProperties.getProperty("accessToken"));
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            JSONObject jsonResponse = ConnectorIntegrationUtil.sendRequest(getProxyServiceURL(methodName), modifiedJsonString);
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getUserVenues} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getUserOrganizers} integration test with mandatory parameters.")
    ...
    public void testGetOrderDetailsWithMandatoryParameters() throws Exception {
        ...
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, eventbriteConnectorProperties.getProperty("accessToken"), eventbriteConnectorProperties.getProperty("orderId"));
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            JSONObject jsonResponse = ConnectorIntegrationUtil.sendRequest(getProxyServiceURL(methodName), modifiedJsonString);
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getContactLists} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getContactListDetails} integration test with mandatory parameters.")
    public void testGetContactListDetailsWithMandatoryParameters() throws Exception {
        ...
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, eventbriteConnectorProperties.getProperty("accessToken"), eventbriteConnectorProperties.getProperty("userId"), eventbriteConnectorProperties.getProperty("contactListId"));
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            JSONObject jsonResponse = ConnectorIntegrationUtil.sendRequest(getProxyServiceURL(methodName), modifiedJsonString);
    ...
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getSpecificContactListDetails} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{eventTeams} integration test.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{eventDetails} integration test.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{eventAttendees} integration test.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{eventAttendeesDetails} integration test.")
    public void testEventAttendeesDetailsWithMandatoryParameters() throws Exception {
        ...
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, eventbriteConnectorProperties.getProperty("accessToken"), eventbriteConnectorProperties.getProperty("eventId"), eventbriteConnectorProperties.getProperty("attendeesId"));
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            JSONObject jsonResponse = ConnectorIntegrationUtil.sendRequest(getProxyServiceURL(methodName), modifiedJsonString);
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{eventTeamsAttendees} integration test.")
    public void testEventTeamsAttendeesWithMandatoryParameters() throws Exception {
        ...
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        String modifiedJsonString = String.format(jsonString, eventbriteConnectorProperties.getProperty("accessToken"), eventbriteConnectorProperties.getProperty("eventId"), eventbriteConnectorProperties.getProperty("teamId"));
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            JSONObject jsonResponse = ConnectorIntegrationUtil.sendRequest(getProxyServiceURL(methodName), modifiedJsonString);
            Assert.assertTrue(jsonResponse.has("attendees"));
     ...
     * Positive test case for testEventTeams method with mandatory parameters.
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{eventTeamsDetails} integration test.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{eventTransfers} integration test.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getEventAccessCodes} integration test.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{getEventDiscounts} integration test.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{testCreateContactListDetailsWithMandatoryParameters} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{createSpecificContactListDetails} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{testcreateSpecificContactListDetailsOptionalParameters} integration test with optional parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{createContactListDetails} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{createEventAccessCodes} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{createEventAccessCodes} integration test with optional parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{createEventDiscount} integration test with mandatory parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{createEventDiscount} integration test with optional parameters.")
     ...
     */
    @Test(enabled = true, groups = {"wso2.esb"}, description = "eventbrite{createEvent} integration test with mandatory parameters.")
