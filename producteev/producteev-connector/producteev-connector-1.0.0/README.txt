...
Steps to follow in setting integration test.
 ...
 5. Prerequisites for Producteev Connector Integration Testing.
	...
	iii)	Create a user in the Network created above and keep the user ID (id displays in the URL when the user is selected) for further reference.
	iv)		Add a task using the project ID created in step 5 i) for further reference.
