...
public class ProducteevConnectorIntegrationTest extends ConnectorIntegrationTestBase {
     ...
     * @throws IOException
     */
    @Test(groups = { "wso2.esb" }, description = "Producteev {createTask} integration test with mandatory parameters.")
    public void testCreateTaskWithMandatoryParameters() throws IOException, JSONException{
        ...
        Assert.assertEquals(connectorProperties.getProperty("taskTitleMandatory"), apiRestResponse.getBody().getJSONObject("task")
                .getString("title"));
     ...
     * @throws IOException
     */
    @Test(groups = { "wso2.esb" }, description = "Producteev {createTask} integration test with optional parameters.")
    public void testCreateTaskWithOptionalParameters() throws IOException, JSONException{
        ...
        Assert.assertEquals(connectorProperties.getProperty("taskTitleOptional"), apiRestResponse.getBody().getJSONObject("task")
                .getString("title"));
        ...
        Assert.assertEquals(connectorProperties.getProperty("endDateTimeZone"), apiRestResponse.getBody()
     ...
     * @throws IOException
     */
    @Test(groups = { "wso2.esb" }, description = "Producteev {createTask} integration test with negative case.")
    public void testCreateTaskWithNegativeCase() throws IOException, JSONException{
        ...
        Assert.assertEquals(esbRestResponse.getBody().getString("error_description"), apiRestResponse.getBody().getString("error_description"));
     ...
     * @throws IOException
     */
    @Test(groups = { "wso2.esb" }, description = "Producteev {createNote} integration test with mandatory parameters.", dependsOnMethods={"testCreateTaskWithOptionalParameters"})
    public void testCreateNoteWithMandatoryParameters() throws IOException, JSONException {
        ...
        Assert.assertEquals(connectorProperties.getProperty("noteMessageMand"), apiRestResponse.getBody().getJSONObject("note")
                .getString("message"));
        ...
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("note").getJSONObject("creator").getString("id"), apiRestResponse
                .getBody().getJSONObject("note").getJSONObject("creator").getString("id"));
    }
     ...
     * @throws IOException
     */
    @Test(groups = { "wso2.esb" }, description = "Producteev {createNote} integration test with optional parameters.")
    public void testCreateNoteWithOptionalParameters() throws IOException, JSONException {
        ...
        final String apiFileId=apiRestResponse.getBody().getJSONObject("note").getJSONArray("files").getJSONObject(0).getString("id");
     ...
     * @throws IOException
     */
    @Test(groups = { "wso2.esb" }, description = "Producteev {createNote} integration test with negative case.", dependsOnMethods="testCreateTaskWithOptionalParameters")
     ...
     * @throws IOException
     */
    @Test(groups = { "wso2.esb" }, description = "Producteev {getNote} integration test with mandatory parameters.", dependsOnMethods={"testCreateNoteWithMandatoryParameters"})
    ...
    /**
     * Test case: testGetNoteWithOptionalParameters. 
     * Status: Skipped. 
     ...
     * @throws IOException
     */
    @Test(groups = { "wso2.esb" }, description = "Producteev {getNote} integration test with negative case.")
     ...
     * @throws IOException
     */
    @Test(groups = { "wso2.esb" }, description = "Producteev {listTaskNotes} integration test with mandatory parameters.",dependsOnMethods={"testCreateNoteWithMandatoryParameters"})
    public void testListTaskNotesWithMandatoryParameters() throws IOException, JSONException {
        ...
        Assert.assertEquals(esbNotesArray.getJSONObject(0).getString("id"), apiNotesArray.getJSONObject(0).getString("id"));
        Assert.assertEquals(esbNotesArray.getJSONObject(0).getString("created_at"), apiNotesArray.getJSONObject(0).getString("created_at"));
        Assert.assertEquals(esbNotesArray.getJSONObject(0).getString("message"), apiNotesArray.getJSONObject(0).getString("message"));
        Assert.assertEquals(esbNotesArray.getJSONObject(0).getString("updated_at"), apiNotesArray.getJSONObject(0).getString("updated_at"));
        Assert.assertEquals(esbNotesArray.getJSONObject(0).getJSONObject("creator").getString("id"), 
        		apiNotesArray.getJSONObject(0).getJSONObject("creator").getString("id"));
    }
    
    /**
     * Test case: testListTaskNotesWithOptionalParameters. 
     * Status: Skipped. 
     * Reason : There are no any optional parameters for the function invocation.
     */ 
     ...
     * @throws IOException
     */
    @Test(groups = { "wso2.esb" }, description = "Producteev {listTaskNotes} integration test with negative case.")
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" },description = "Producteev {assignTask} integration test with mandatory parameters.",dependsOnMethods = { "testCreateTaskWithMandatoryParameters" })
   public void testAssignTaskWithMandatoryParameters() throws IOException, JSONException{
       ...
       Assert.assertEquals(esbRestResponse.getBody().getJSONArray("users").length(), apiRestResponse.getBody().getJSONObject("task").getJSONArray("responsibles").length());
       Assert.assertEquals(esbRestResponse.getBody().getJSONArray("users").getJSONObject(1).getString("id"), apiRestResponse.getBody().getJSONObject("task").getJSONArray("responsibles").getJSONObject(1).getString("id"));
       Assert.assertEquals(esbRestResponse.getBody().getJSONArray("users").getJSONObject(1).getString("firstname"), apiRestResponse.getBody().getJSONObject("task").getJSONArray("responsibles").getJSONObject(1).getString("firstname"));
   }    
  
   /**
    * Test case: testAssignTaskWithOptionalParameters. 
    * Status: Skipped. 
    * Reason : There are no any optional parameters for the function invocation.
    */  
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {assignTask} integration test with negative case.")
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" },description = "Producteev {removeAssignee} integration test with mandatory parameters.",dependsOnMethods = { "testAssignTaskWithMandatoryParameters" })
   public void testRemoveAssigneeWithMandatoryParameters() throws IOException, JSONException{
       ...
       int assignedUsersCountBefore=apiRestResponseBefore.getBody().getJSONObject("task").getJSONArray("responsibles").length();
       ...
       int assignedUsersCountAfter=apiRestResponseAfter.getBody().getJSONObject("task").getJSONArray("responsibles").length();
   ...
   /**
    * Test case: testRemoveAssigneeWithOptionalParameters. 
    * Status: Skipped. 
    * Reason : There are no any optional parameters for the function invocation.
    */ 
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {removeAssignee} integration test with negative case.",dependsOnMethods = { "testCreateTaskWithMandatoryParameters" })
   public void testRemoveAssigneeWithNegativeCase() throws IOException, JSONException{
       ...
       String apiEndpoint = apiUrl + "/tasks/" + connectorProperties.getProperty("taskIdMandatory") + "/responsibles/INVALID";
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" },description = "Producteev {getUser} integration test with mandatory parameters.")
   public void testGetUserWithMandatoryParameters() throws IOException, JSONException{
       ...
       Assert.assertEquals(esbRestResponse.getBody().getJSONObject("user").getString("id"), apiRestResponse.getBody().getJSONObject("user").getString("id"));
       Assert.assertEquals(esbRestResponse.getBody().getJSONObject("user").getString("firstname"),apiRestResponse.getBody().getJSONObject("user").getString("firstname"));
       Assert.assertEquals(esbRestResponse.getBody().getJSONObject("user").getString("email"), apiRestResponse.getBody().getJSONObject("user").getString("email"));
   } 
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {getUser} integration test with negative case.")
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {inviteUserToNetwork} integration test with mandatory parameters.")
   public void testInviteUserToNetworkWithMandatoryParameters() throws IOException, JSONException{
       ...
       //Attempting to invite the same user to the network which would cause a conflict to check the user added to network or not.
       RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndpoint, "POST", apiRequestHeadersMap,"api_inviteUserToNetwork_mandatory.json");
       
       Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 201);
       Assert.assertEquals(esbRestResponse.getBody().getJSONObject("network_invitation").getString("email"), connectorProperties.getProperty("invitationEmail"));
   ...
   /**
    * Test case: testInviteUserToNetworkWithOptionalParamaters 
    * Status: Skipped. 
    * Reason : There are no any optional parameters for the function invocation.
    */     
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {inviteUserToNetwork} integration test with negative case.")
   public void testInviteUserToNetworkWithNegativeCase() throws IOException, JSONException{
       ...
       RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndpoint, "POST", apiRequestHeadersMap,"api_inviteUserToNetwork_negative.json");
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateTaskWithOptionalParameters" }, description = "Producteev {getTask} integration test with mandatory parameters.")
   public void testGetTaskWithMandatoryParameters() throws IOException, JSONException {
       ...
       Assert.assertEquals(esbRestResponse.getBody().getJSONObject("task").getString("title"), apiRestResponse
               .getBody().getJSONObject("task").getString("title"));
       Assert.assertEquals(esbRestResponse.getBody().getJSONObject("task").getString("status"), apiRestResponse
               .getBody().getJSONObject("task").getString("status"));
       Assert.assertEquals(esbRestResponse.getBody().getJSONObject("task").getString("priority"), apiRestResponse
               .getBody().getJSONObject("task").getString("priority"));
   ...
   /**
    *  Test case: testGetTaskWithOptionalParameters.        
    *  Status: Skipped.        
    *  Reason : There are no any optional parameters for the function invocation.      
    */
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {getTask} integration test with negative case.")
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateTaskWithOptionalParameters", "testCreateTaskWithMandatoryParameters" }, description = "Producteev {listTasks} integration test with mandatory parameters.")
   public void testListTasksWithMandatoryParameters() throws IOException, JSONException {
       ...
       JSONObject esbLastTaskObject=esbRestResponse.getBody().getJSONArray("tasks").getJSONObject(esbRestResponse.getBody().getJSONArray("tasks").length() - 1);
       
       JSONObject apiFirstTaskObject=apiRestResponse.getBody().getJSONArray("tasks").getJSONObject(0);
       JSONObject apiLastTaskObject=apiRestResponse.getBody().getJSONArray("tasks").getJSONObject(apiRestResponse.getBody().getJSONArray("tasks").length() - 1);
       ...
       Assert.assertEquals(esbRestResponse.getBody().getJSONArray("tasks").length(), apiRestResponse.getBody().getJSONArray("tasks").length());
       Assert.assertEquals(esbRestResponse.getBody().getString("total_hits"), apiRestResponse.getBody().getString("total_hits"));
    ...
    * @throws IOException
    */
   @Test(dependsOnMethods = { "testCreateTaskWithOptionalParameters", "testCreateTaskWithMandatoryParameters" }, description = "Producteev {listTasks} integration test with optional parameters.")
    ...
    * @throws IOException
    */
   @Test(description = "Producteev {listTasks} integration test with negative case.")
   ...
   /**
    * Test case: testUpdateTaskWithMandatoryParameters.        
    * Status: Skipped.        
    * Reason : There are no any mandatory parameter(s) for the function invocation.      
    */
    ...
    * @throws IOException
    */
   @Test(dependsOnMethods = { "testCreateTaskWithOptionalParameters" }, description = "Producteev {updateTask} integration test with optional parameters.")
   public void testUpdateTaskWithOptionalParameters() throws IOException, JSONException {
       ...
       Assert.assertEquals(connectorProperties.getProperty("updateTaskTitle"), apiRestResponseAfter.getBody().getJSONObject("task")
               .getString("title"));
       Assert.assertEquals(connectorProperties.getProperty("updateTaskEndDate").substring(0, 10), apiRestResponseAfter.getBody().getJSONObject("task")
               .getString("deadline").substring(0, 10));
       Assert.assertEquals(connectorProperties.getProperty("updateTaskEndDateTimeZone"), apiRestResponseAfter.getBody().getJSONObject("task")
               .getString("deadline_timezone"));
       Assert.assertEquals(connectorProperties.getProperty("taskStatus"), apiRestResponseAfter.getBody().getJSONObject("task")
               .getString("status"));
       Assert.assertEquals(connectorProperties.getProperty("taskPriority"), apiRestResponseAfter.getBody().getJSONObject("task")
               .getString("priority"));
       ...
       Assert.assertNotEquals(apiRestResponseBefore.getBody().getJSONObject("task").getString("deadline").substring(0,
               10), apiRestResponseAfter.getBody().getJSONObject("task").getString("deadline").substring(0, 10));
    ...
    * @throws IOException
    */
   @Test(description = "Producteev {updateTask} integration test with negative case.")
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {addLabelToTask} integration test with mandatory parameters.", dependsOnMethods = { "testCreateTaskWithMandatoryParameters" })
   ...
   /**
    * Test case: testAddLabelToTaskWithOptionalParameters. 
    * Status: Skipped. 
    * Reason : There are no any optional parameters for the function invocation.
    */
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {addLabelToTask} integration test with negative case.", dependsOnMethods = { "testCreateTaskWithMandatoryParameters" })
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {addFollowerToTask} integration test with mandatory parameters.", dependsOnMethods = { "testCreateTaskWithMandatoryParameters" })
   ...
   /**
    * Test case: testAddFollowerToTaskWithOptionalParameters. 
    * Status: Skipped. 
    * Reason : There are no any optional parameters for the function invocation.
    */
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {addFollowerToTask} integration test with negative case.", dependsOnMethods = { "testCreateTaskWithMandatoryParameters" })
   ...
   /**
    * Test case: testUpdateLabelWithMandatoryParameters.
    *  Status: Skipped.
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {updateLabel} method with optional parameters.")
    ...
    * @throws IOException
    */
   @Test(groups = { "wso2.esb" }, description = "Producteev {updateLabel} integration test with negative case.")
   public void testUpdateLabelWithNegativeCase() throws IOException, JSONException {
     ...
     * @throws IOException
     */
    public final String getFileId(final String taskId) throws IOException, JSONException{
