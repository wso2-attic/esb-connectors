...
public class GoogleDriveUtils {
     ...
     * @param elements HashMap(String,String) value.
     * @return resultTag return result.
     */
    public static OMElement buildResultEnvelope(final String namespace, final String resultTagName,
            final boolean success, final Map<String, String> elements) {
        ...
        if (elements != null) {
            ...
            while (elementIterator.hasNext()) {
                Map.Entry<String, String> element = (Map.Entry<String, String>) elementIterator.next();
     ...
     * 
     * @param httpTransport NetHttpTransport
     ...
     */
    public static Drive getDriveService(final MessageContext messageContext, final HttpTransport httpTransport,
        ...
        if (useServiceAccount) {
            auth =
                    new GoogleDriveUtils.GoogleDriveAuth(
                            (String) messageContext.getProperty(GoogleDriveUtils.StringConstants.SERVICE_ACCOUNT_EMAIL),
        ...
        switch (auth.getAuthType()) {
            case GoogleDriveAuth.AUTH_TYPE_SERVICE_ACCOUNT:
                try {
                    ...
                    byte[] md5Bytes = messageDigest.digest(auth.getServicePKCS12FileContent().getBytes());
                    for (byte b : md5Bytes) {
                    ...
                    credential =
                            new GoogleCredential.Builder()
                                    ...
                                    .setServiceAccountPrivateKeyFromP12File(
                                            writeToTempFile(sb.toString() + ".p12", auth.getServicePKCS12FileContent()))
                                    .build();
                } catch (Exception e) {
            ...
            case GoogleDriveAuth.AUTH_TYPE_CLIENT_ACCOUNT:
                credential =
                        new GoogleCredential.Builder().setTransport(httpTransport).setJsonFactory(jsonFactory)
                                .setClientSecrets(auth.getClientId(), auth.getClientSecret()).build()
                                .setAccessToken(auth.getAccessToken()).setRefreshToken(auth.getRefreshToken());
                break;
            default:
                credential = null;
        }
     ...
     * @param base64FileContent Base64-encoded file content
     * @return <strong>java.io.File</strong> resource
     * @throws FileNotFoundException
     * @throws IOException
     * @throws Exception throw if an error occur
     */
    public static java.io.File writeToTempFile(final String filename, final String base64FileContent) throws Exception {
        ...
        java.io.File writtenFile =
                new java.io.File(writtenFileFolder.getAbsolutePath() + System.getProperty("file.separator") + filename);
    ...
    public static class GoogleDriveAuth {
         ...
         * 
         * @param serviceAccountsEmail serviceAccountEmail value
         * @param serviceFileContent serviceFileContent value
         */
        public GoogleDriveAuth(final String serviceAccountsEmail, final String serviceFileContent) {
         ...
         * 
         * @param clientsId clientId value
         * @param refreshTokenId refreshToken value
         * @param clientsSecret clientSecret value
         * @param accesstokenId accessToken value
         */
        public GoogleDriveAuth(final String clientsId, final String clientsSecret, final String accesstokenId,
        ...
        public final String toString() {
            ...
            return "Service email: " + this.getServiceAccountEmail() + " PKCS12 Filepath: "
                    + this.getServicePKCS12FileContent();
        }
        ...
        /**
         * @param authsType the auth_type to set
        ...
        /**
         * @param servicesAccountName the service Account Name to set
         */
        public final void setServiceAccountEmail(final String servicesAccountName) {
        ...
        /**
         * @param servicePKCS12fileContent the servicePKCS12FileContent to set
         */
        public final void setServicePKCS12FileContent(final String servicePKCS12fileContent) {
        ...
        /**
         * @param clientsId the client_id to set
         */
        ...
        /**
         * @param clientsSecret the client_secret to set
         */
        ...
        /**
         * @param accessTokenId the access_token to set
         */
        ...
        /**
         * @param refreshTokenId the refreshToken to set
         */
