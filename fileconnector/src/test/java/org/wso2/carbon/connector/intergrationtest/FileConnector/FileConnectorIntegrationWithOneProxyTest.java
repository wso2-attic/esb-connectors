...
public class FileConnectorIntegrationWithOneProxyTest extends ConnectorIntegrationTestBase {
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "Fileconnector delete file intergration test")
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "Fileconnector read file intergration test")
