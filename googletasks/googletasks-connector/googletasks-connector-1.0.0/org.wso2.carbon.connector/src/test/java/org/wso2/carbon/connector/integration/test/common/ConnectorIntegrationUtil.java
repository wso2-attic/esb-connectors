...
public class ConnectorIntegrationUtil {
	 ...
	 * @throws IOException
	 */
	public static RestResponse sendRequest(String addUrl, String query) throws IOException {
		...
		int resc=httpConn.getResponseCode();
		...
		try {
			...
			log.error("No JSON objects found in the response body.");
			log.info("Body content:" + out);
		}
	 ...
	 */
	public static RestResponse sendDirectRequest(String addUrl, String httpMethod, String query,
