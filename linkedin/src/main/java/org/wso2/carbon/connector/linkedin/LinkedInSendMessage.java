 ...
 * <strong>mailbox</strong> method
 * 
 * @see http://developer.linkedin.com/documents/messaging-between-connections-api
 * 
 */
public class LinkedInSendMessage extends AbstractConnector implements Connector {
	...
	public void connect(MessageContext messageContext) throws ConnectException {
		...
		messageContext.setProperty(LinkedinUtils.StringConstants.POST_MESSAGE, messageJson);
