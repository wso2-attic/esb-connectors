   ...
   3. Follow the below mentioned steps for adding valid certificate to access bugherd API over https.
   ...
   7. Update the BugHerd properties file at location "<BUGHERD_CONNECTOR_HOME>/bugherd-connector/bugherd-connector-1.0.0/org.wso2.carbon.connector/src/test/resources/artifacts/ESB/connector/config" as below.
