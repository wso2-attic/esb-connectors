...
public class ZendeskConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void testUploadFilesWithOptionalParameters() throws Exception {
        ...
        String requestString =
                proxyUrl + "?apiUrl=" + connectorProperties.getProperty("apiUrl") + "&username="
                        + connectorProperties.getProperty("username") + "&password="
                        + connectorProperties.getProperty("password") + "&fileName=" + fileNameOptional + "&token="
                        + token;
        ...
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("upload").getJSONArray("attachments")
                .getJSONObject(0).getString("file_name"), fileNameOptional);
    ...
    public void testListTicketsWithMandatoryParameters() throws Exception {
        ...
        Assert.assertEquals(esbRestResponse.getBody().getString("count").toString(), apiRestResponse.getBody()
    ...
    public void testListTicketsWithOptionalParameters() throws Exception {
        ...
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(
                esbRestResponse.getBody().getJSONArray("tickets").getJSONObject(0).getString("external_id"),
    ...
    public void testListTicketsForOrganizationIdWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(connectorProperties.getProperty("apiUrl") + "/api/v2/organizations/"
                        + organizationId + "/tickets.json", "GET", apiRequestHeadersMap);
    ...
    public void testListTicketsForUserIdWithMandatoryParameters() throws Exception {
        ...
        Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
        Assert.assertEquals(esbRestResponse.getBody().getJSONArray("tickets").getJSONObject(0)
                .getString("requester_id"), apiRestResponse.getBody().getJSONArray("tickets").getJSONObject(0)
                .getString("requester_id"));
        Assert.assertEquals(esbRestResponse.getBody().getString("count").toString(), apiRestResponse.getBody()
                .getString("count").toString());
    }
    ...
    public void testListTicketsForCcdNegativeCase() throws Exception {
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(connectorProperties.getProperty("apiUrl")
                        + "/api/v2/users/INVALID/tickets/ccd.json", "GET", apiRequestHeadersMap);
    ...
    public void testGetAttachmentNegativeCase() throws Exception {
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(connectorProperties.getProperty("apiUrl") + "/api/v2/attachments/INVALID.json",
                        "GET", apiRequestHeadersMap);
    ...
    public void testSearchWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(connectorProperties.getProperty("apiUrl") + "/api/v2/search.json?query=" + "\""
                        + connectorProperties.getProperty("query") + "\"" + "&sort_by=created_at", "GET",
                        apiRequestHeadersMap);
    ...
    public void testDeleteTicketWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(
                        connectorProperties.getProperty("apiUrl") + "/api/v2/tickets/" + ticketId + ".json", "GET",
                        apiRequestHeadersMap);
    ...
    public void testShoWMultipleTicketsWithMandatoryParameters() throws Exception {
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(connectorProperties.getProperty("apiUrl") + "/api/v2/tickets/show_many.json",
                        "POST", apiRequestHeadersMap);
    ...
    public void testShoWMultipleTicketsWithOptionalParameters() throws Exception {
        ...
        for (int i = 0; i < esbTicketListLength; i++) {
            ...
            Assert.assertEquals(
                    esbRestResponse.getBody().getJSONArray("tickets").getJSONObject(i).getString("subject"),
                    apiRestResponse.getBody().getJSONArray("tickets").getJSONObject(i).getString("subject"));
            Assert.assertEquals(
                    esbRestResponse.getBody().getJSONArray("tickets").getJSONObject(i).getString("description"),
    ...
    public void testCreateTicketWithOptionalParameters() throws Exception {
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(connectorProperties.getProperty("apiUrl") + "/api/v2/tickets/" + id + ".json",
                        "GET", apiRequestHeadersMap);
        ...
        Assert.assertEquals(attachmentId, esbRestResponse.getBody().getJSONObject("audit").getJSONArray("events")
                .getJSONObject(0).getJSONArray("attachments").getJSONObject(0).getString("id"));
    ...
    public void testCreateTicketWithNegativeCase() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createTicket_invalid.json",
                        parametersMap);
        ...
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("details").getJSONArray("base").getJSONObject(0)
                .get("description"), apiRestResponse.getBody().getJSONObject("details").getJSONArray("base")
    ...
    public void testUpdateTicketWithMandatoryParameters() throws Exception {
        ...
        Assert.assertEquals(esbRestResponse.getBody().getJSONObject("ticket").getString("requester_id"),
                apiRestResponse.getBody().getJSONObject("ticket").getString("requester_id"));
    ...
    public void testUpdateTicketWithOptionalParameters() throws Exception {
        ...
        Assert.assertEquals(
                attachmentIdOptional,
                esbRestResponse.getBody().getJSONObject("audit").getJSONArray("events").getJSONObject(0)
                        .getJSONArray("attachments").getJSONObject(0).getString("id"));
    ...
    public void testUpdateTicketWithNegativeCase() throws Exception {
        ...
        RestResponse<JSONObject> esbRestResponse =
                sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_udpateTicket_invalid.json",
                        parametersMap);
        
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(
                        connectorProperties.getProperty("apiUrl") + "/api/v2/tickets/" + ticketId + ".json", "PUT",
                        apiRequestHeadersMap, "api_updateTicket_invalid.json", apiParametersMap);
    ...
    public void testDeleteUplaodWithNegativeCase() throws Exception {
        ...
        RestResponse<JSONObject> apiRestResponse =
                sendJsonRestRequest(connectorProperties.getProperty("apiUrl") + "/api/v2/uploads/INVALID.json",
                        "DELETE", apiRequestHeadersMap);
