...
public class FreshbooksConnectorIntegrationTest extends ConnectorIntegrationTestBase {
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "Freshbooks {createExpense} integration test with mandatory parameters.")
    ...
    public void testCreateClientWithMandatoryParameters() throws Exception {
        ...
        // sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap,
        // "api_deleteClient.xml",parametersMap);
    }
    
    /**
     * Positive test case for deleteClient method with mandatory parameters.
     */
    @Test(dependsOnMethods = { "testCreateClientWithMandatoryParameters" }, groups = { "wso2.esb" }, description = "Freshbooks {deleteClient} integration test with mandatory parameters.")
     ...
     */
    @Test(dependsOnMethods = { "testDeleteClientWithMandatoryParameters" }, groups = { "wso2.esb" }, description = "Freshbooks {createClient} integration test with optional parameters.")
     ...
     */
    @Test(dependsOnMethods = { "testCreateClientWithOptionalParameters" }, groups = { "wso2.esb" }, description = "Freshbooks {getClient} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "Freshbooks {createProject} integration test with mandatory parameters.")
    public void testCreateProjectWithMandatoryParameters() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:createProject");
        
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createProject_mandatory.xml");
        
        connectorProperties.setProperty("projectIdMandatory",
                getValueByExpression("//*[local-name()='project_id']", esbRestResponse.getBody()));
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_createProject_mandatory.xml",
                        parametersMap);
        
        Assert.assertEquals(
                getValueByExpression("string(//*[local-name()='response']/@status)", esbRestResponse.getBody()), "ok");
        Assert.assertEquals(
                Integer.parseInt(getValueByExpression("//*[local-name()='project_id']/text()",
                        esbRestResponse.getBody())),
                Integer.parseInt(getValueByExpression("//*[local-name()='project_id']/text()",
                        apiRestResponse.getBody())));
        Assert.assertEquals(connectorProperties.getProperty("projectName"),
                getValueByExpression("//*[local-name()='name']/text()", apiRestResponse.getBody()));
        Assert.assertEquals(connectorProperties.getProperty("projectBillMethod"),
                getValueByExpression("//*[local-name()='bill_method']/text()", apiRestResponse.getBody()));
    }
    
    /**
     * Positive test case for createProject method with optional parameters.
     */
    @Test(dependsOnMethods = { "testCreateClientWithOptionalParameters" }, groups = { "wso2.esb" }, description = "Freshbooks {createProject} integration test with optional parameters.")
    public void testCreateProjectWithOptionalParameters() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:createProject");
        
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createProject_optional.xml");
        
        connectorProperties.setProperty("projectIdOptional",
                getValueByExpression("//*[local-name()='project_id']", esbRestResponse.getBody()));
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_createProject_optional.xml",
                        parametersMap);
        
        Assert.assertEquals(
                getValueByExpression("string(//*[local-name()='response']/@status)", esbRestResponse.getBody()), "ok");
        Assert.assertEquals(connectorProperties.getProperty("clientIdOptional"),
                getValueByExpression("//*[local-name()='client_id']/text()", apiRestResponse.getBody()));
        Assert.assertEquals(connectorProperties.getProperty("projectDescription"),
                getValueByExpression("//*[local-name()='description']/text()", apiRestResponse.getBody()));
        Assert.assertEquals(
                connectorProperties.getProperty("projectHourBudget"),
                getValueByExpression("//*[local-name()='budget']/*[local-name()='hours']/text()",
                        apiRestResponse.getBody()));
        Assert.assertEquals(
                connectorProperties.getProperty("timeEntryTaskId"),
                getValueByExpression("//*[local-name()='task']/*[local-name()='task_id']/text()",
                        apiRestResponse.getBody()));
    }
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "Freshbooks {createProject} negative integration test.")
    public void testCreateProjectNegativeCase() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:createProject");
        
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createProject_negative.xml");
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_createProject_negative.xml");
     ...
     */
    @Test(dependsOnMethods = { "testCreateProjectWithOptionalParameters" }, groups = { "wso2.esb" }, description = "Freshbooks {createTimeEntry} integration test with mandatory parameters.")
    public void testCreateTimeEntryWithMandatoryParameters() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:createTimeEntry");
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createTimeEntry_mandatory.xml");
        
        connectorProperties.setProperty("timeEntryIdMandatory",
                getValueByExpression("//*[local-name()='time_entry_id']", esbRestResponse.getBody()));
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_createTimeEntry_mandatory.xml",
                        parametersMap);
        
        Assert.assertEquals(
                getValueByExpression("string(//*[local-name()='response']/@status)", esbRestResponse.getBody()), "ok");
        Assert.assertEquals(
                Integer.parseInt(getValueByExpression("//*[local-name()='time_entry_id']/text()",
                        esbRestResponse.getBody())),
                Integer.parseInt(getValueByExpression("//*[local-name()='time_entry_id']/text()",
                        apiRestResponse.getBody())));
        Assert.assertEquals(connectorProperties.getProperty("projectIdOptional"),
                getValueByExpression("//*[local-name()='project_id']/text()", apiRestResponse.getBody()));
        Assert.assertEquals(connectorProperties.getProperty("timeEntryTaskId"),
                getValueByExpression("//*[local-name()='task_id']/text()", apiRestResponse.getBody()));
    }
    
    /**
     * Positive test case for createTimeEntry method with optional parameters.
     */
    @Test(dependsOnMethods = { "testCreateProjectWithOptionalParameters" }, groups = { "wso2.esb" }, description = "Freshbooks {createTimeEntry} integration test with optional parameters.")
    public void testCreateTimeEntryWithOptionalParameters() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:createTimeEntry");
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createTimeEntry_optional.xml");
        
        connectorProperties.setProperty("timeEntryIdOptional",
                getValueByExpression("//*[local-name()='time_entry_id']", esbRestResponse.getBody()));
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_createTimeEntry_optional.xml",
                        parametersMap);
        ...
        Assert.assertEquals(
                ...
                Integer.parseInt(getValueByExpression("//*[local-name()='time_entry_id']/text()",
                        apiRestResponse.getBody())));
        Assert.assertEquals(connectorProperties.getProperty("staffId"),
                getValueByExpression("//*[local-name()='staff_id']/text()", apiRestResponse.getBody()));
        Assert.assertEquals(connectorProperties.getProperty("timeEntryHours"),
                getValueByExpression("//*[local-name()='hours']/text()", apiRestResponse.getBody()));
        Assert.assertEquals(connectorProperties.getProperty("timeEntryNote"),
                getValueByExpression("//*[local-name()='notes']/text()", apiRestResponse.getBody()));
        Assert.assertEquals(connectorProperties.getProperty("timeEntryDate"),
                getValueByExpression("//*[local-name()='date']/text()", apiRestResponse.getBody()));
    }
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "Freshbooks {createTimeEntry} negative integration test.")
    public void testCreateTimeEntryNegativeCase() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:createTimeEntry");
        
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createTimeEntry_negative.xml");
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_createTimeEntry_negative.xml");
     ...
     */
    @Test(dependsOnMethods = { "testCreateTimeEntryWithOptionalParameters", "testCreateProjectWithMandatoryParameters" }, groups = { "wso2.esb" }, description = "Freshbooks {updateTimeEntry} integration test with optional parameters.")
    public void testUpdateTimeEntryWithOptionalParameters() throws Exception {
        ...
        // getting the timeEntry record before the update
        RestResponse<OMElement> apiRestResponseBefore =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_updateTimeEntry_optional.xml",
                        parametersMap);
        
        // updating the timeEntry record
        sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateTimeEntry_optional.xml");
        
        // getting the timeEntry record after the update
        RestResponse<OMElement> apiRestResponseAfter =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_updateTimeEntry_optional.xml",
                        parametersMap);
        
        Assert.assertNotEquals(
                getValueByExpression("//*[local-name()='project_id']/text()", apiRestResponseBefore.getBody()),
                getValueByExpression("//*[local-name()='project_id']/text()", apiRestResponseAfter.getBody()));
        Assert.assertNotEquals(
                getValueByExpression("//*[local-name()='task_id']/text()", apiRestResponseBefore.getBody()),
                getValueByExpression("//*[local-name()='task_id']/text()", apiRestResponseAfter.getBody()));
        Assert.assertNotEquals(
                getValueByExpression("//*[local-name()='hours']/text()", apiRestResponseBefore.getBody()),
                getValueByExpression("//*[local-name()='hours']/text()", apiRestResponseAfter.getBody()));
        Assert.assertNotEquals(
                getValueByExpression("//*[local-name()='notes']/text()", apiRestResponseBefore.getBody()),
                getValueByExpression("//*[local-name()='notes']/text()", apiRestResponseAfter.getBody()));
        Assert.assertNotEquals(
                getValueByExpression("//*[local-name()='date']/text()", apiRestResponseBefore.getBody()),
                getValueByExpression("//*[local-name()='date']/text()", apiRestResponseAfter.getBody()));
    }
    
    /**
     * Negative test case for updateTimeEntry method.
     */
    @Test(groups = { "wso2.esb" }, description = "Freshbooks {updateTimeEntry} negative integration test.")
    public void testUpdateTimeEntryNegativeCase() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:updateTimeEntry");
        
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateTimeEntry_negative.xml");
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_updateTimeEntry_negative.xml");
     ...
     */
    @Test(dependsOnMethods = { "testCreateTimeEntryWithMandatoryParameters" }, groups = { "wso2.esb" }, description = "Freshbooks {getTimeEntry} integration test with mandatory parameters.")
    public void testGetTimeEntryWithMandatoryParameters() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:getTimeEntry");
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getTimeEntry_mandatory.xml");
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_getTimeEntry_mandatory.xml");
        
        Assert.assertEquals(
                getValueByExpression("string(//*[local-name()='response']/@status)", esbRestResponse.getBody()), "ok");
        Assert.assertEquals(getValueByExpression("//*[local-name()='project_id']/text()", esbRestResponse.getBody()),
                getValueByExpression("//*[local-name()='project_id']/text()", apiRestResponse.getBody()));
        Assert.assertEquals(getValueByExpression("//*[local-name()='task_id']/text()", esbRestResponse.getBody()),
                getValueByExpression("//*[local-name()='task_id']/text()", apiRestResponse.getBody()));
        Assert.assertEquals(getValueByExpression("//*[local-name()='date']/text()", esbRestResponse.getBody()),
                getValueByExpression("//*[local-name()='date']/text()", apiRestResponse.getBody()));
    }
    ...
    /**
     * Negative test case for getTimeEntry method with optional parameters.
     */
    @Test(groups = { "wso2.esb" }, description = "Freshbooks {getTimeEntry} negative integration test.")
    public void testGetTimeEntryNegativeCase() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:getTimeEntry");
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_getTimeEntry_negative.xml");
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_getTimeEntry_negative.xml");
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "Freshbooks {listTimeEntries} integration test with mandatory parameters.")
    public void testListTimeEntriesWithMandatoryParameters() throws Exception {
        ...
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_listTimeEntries_mandatory.xml");
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_listTimeEntries_mandatory.xml");
        
        Assert.assertEquals(
                getValueByExpression("string(//*[local-name()='response']/@status)", esbRestResponse.getBody()), "ok");
        Assert.assertEquals(
                getValueByExpression("string(//*[local-name()='time_entries']/@total)", esbRestResponse.getBody()),
                getValueByExpression("string(//*[local-name()='time_entries']/@total)", apiRestResponse.getBody()));
        Assert.assertEquals(
                getValueByExpression("//*[local-name()='time_entry'][1]/*[local-name()='time_entry_id']/text()",
                        esbRestResponse.getBody()),
                getValueByExpression("//*[local-name()='time_entry'][1]/*[local-name()='time_entry_id']/text()",
                        apiRestResponse.getBody()));
    }
     ...
     */
    @Test(groups = { "wso2.esb" }, description = "Freshbooks {listTimeEntries} integration test with optional parameters.")
    public void testListTimeEntriesWithOptionalParameters() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:listTimeEntries");
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_listTimeEntries_optional.xml");
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_listTimeEntries_optional.xml");
        
        Assert.assertEquals(
                getValueByExpression("string(//*[local-name()='time_entries']/@total)", esbRestResponse.getBody()),
                getValueByExpression("string(//*[local-name()='time_entries']/@total)", apiRestResponse.getBody()));
        Assert.assertEquals(
                getValueByExpression("string(//*[local-name()='time_entries']/@page)", esbRestResponse.getBody()),
                connectorProperties.getProperty("timeEntryPage"));
        Assert.assertEquals(
                getValueByExpression("string(//*[local-name()='time_entries']/@per_page)", esbRestResponse.getBody()),
                connectorProperties.getProperty("timeEntryPerPage"));
        Assert.assertEquals(
                getValueByExpression("//*[local-name()='time_entry'][1]/*[local-name()='project_id']/text()",
                        esbRestResponse.getBody()), connectorProperties.getProperty("projectIdOptional"));
        Assert.assertEquals(
                getValueByExpression("//*[local-name()='time_entry'][1]/*[local-name()='task_id']/text()",
                        esbRestResponse.getBody()), connectorProperties.getProperty("timeEntryTaskId"));
    }
    
    /**
     * Negative test case for listTimeEntries method with optional parameters.
     */
    @Test(groups = { "wso2.esb" }, description = "Freshbooks {listTimeEntry} negative integration test.")
    public void testListTimeEntriesNegativeCase() throws Exception {
    
        esbRequestHeadersMap.put("Action", "urn:listTimeEntries");
        RestResponse<OMElement> esbRestResponse =
                sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_listTimeEntries_negative.xml");
        
        String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
        RestResponse<OMElement> apiRestResponse =
                sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_listTimeEntries_negative.xml");
