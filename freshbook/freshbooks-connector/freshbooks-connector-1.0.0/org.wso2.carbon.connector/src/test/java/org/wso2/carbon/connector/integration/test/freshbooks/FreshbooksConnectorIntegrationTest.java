...
public class FreshbooksConnectorIntegrationTest extends ConnectorIntegrationTestBase {
   ...
   public void testCreateExpenseWithMandatoryParameters() throws Exception {
      ...
      Assert.assertEquals(
            Integer.parseInt(getValueByExpression("//*[local-name()='expense_id']/text()", esbRestResponse.getBody())),
            Integer.parseInt(getValueByExpression("//*[local-name()='expense_id']/text()", apiRestResponse.getBody())));
   ...
   public void testListExpenseWithOptionalParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_listExpense_optional.xml", parametersMap);
      
      String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
      RestResponse<OMElement> apiRestResponse =
            sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_listExpense_optional.xml", parametersMap);
   ...
   public void testCreateInvoiceWithOptionalParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createInvoice_optional.xml", parametersMap);
   ...
   public void testUpdateInvoiceWithOptionalParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateInvoice_optional.xml", parametersMap);
   ...
   public void testAddInvoiceLineWithMandatoryParameters() throws Exception {
      ...
      Assert.assertEquals(
            getValueByExpression("string(//*[local-name()='response']/@status)", esbRestResponse.getBody()), "ok");
      Assert.assertEquals(selectedLine.getFirstChildWithName(nameQName).getText(), parametersMap.get("invoiceLineName"));
   }
   ...
   public void testAddInvoiceLineWithOptionalParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_addInvoiceLine_optional.xml", parametersMap);
   ...
   public void testUpdateInvoiceLineWithOptionalParameters() throws Exception {
      ...
      Assert.assertEquals(selectedLine.getFirstChildWithName(descriptionQName).getText(),
            parametersMap.get("description"));
      Assert.assertEquals(selectedLine.getFirstChildWithName(quantityQName).getText(), parametersMap.get("compoundTax"));
   }
   ...
   public void testDeleteInvoiceNegativeCase() throws Exception {
      ...
      esbRequestHeadersMap.put("Action", "urn:deleteInvoice");
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_deleteInvoice_negative.xml", parametersMap);
   ...
   public void testCreateClientWithMandatoryParameters() throws Exception {
      ...
      Assert.assertEquals(
            getValueByExpression("string(//*[local-name()='response']/@status)", esbRestResponse.getBody()), "ok");
      Assert.assertEquals(
            Integer.parseInt(getValueByExpression("//*[local-name()='client_id']/text()", esbRestResponse.getBody())),
            Integer.parseInt(getValueByExpression("//*[local-name()='client_id']/text()", apiRestResponse.getBody())));
   ...
   public void testCreateClientWithOptionalParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createClient_optional.xml", parametersMap);
   ...
   public void testUpdateClientWithOptionalParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateClient_optional.xml", parametersMap);
   ...
   public void testGetClientNegativeCase() throws Exception {
      ...
      String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
      RestResponse<OMElement> apiRestResponse =
            sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_getClient_negative.xml", parametersMap);
   ...
   public void testCreatePaymentWithMandatoryParameters() throws Exception {
      ...
      Assert.assertEquals(
            getValueByExpression("string(//*[local-name()='response']/@status)", esbRestResponse.getBody()), "ok");
      Assert.assertEquals(
            Integer.parseInt(getValueByExpression("//*[local-name()='payment_id']/text()", esbRestResponse.getBody())),
            Integer.parseInt(getValueByExpression("//*[local-name()='payment_id']/text()", apiRestResponse.getBody())));
   }
   ...
   public void testCreatePaymentWithOptionalParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createPayment_optional.xml", parametersMap);
      ...
      Assert.assertEquals(new DecimalFormat("#.##").format(new Float(getValueByExpression("//*[local-name()='amount']",
            apiRestResponse.getBody()))), parametersMap.get("amount"));
   ...
   public void testUpdatePaymentWithOptionalParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updatePayment_optional.xml", parametersMap);
   ...
   public void testListPaymentsNegativeCase() throws Exception {
      ...
      esbRequestHeadersMap.put("Action", "urn:listPayments");
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_listPayments_negative.xml", parametersMap);
   ...
   public void testCreateEstimateWithMandatoryParameters() throws Exception {
      ...
      Assert.assertEquals(
            getValueByExpression("string(//*[local-name()='response']/@status)", esbRestResponse.getBody()), "ok");
      Assert.assertEquals(
            Integer.parseInt(getValueByExpression("//*[local-name()='estimate_id']/text()", esbRestResponse.getBody())),
            Integer.parseInt(getValueByExpression("//*[local-name()='estimate_id']/text()", apiRestResponse.getBody())));
   }
   ...
   public void testCreateEstimateWithOptionalParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_createEstimate_optional.xml", parametersMap);
   ...
   public void testUpdateEstimateWithOptionalParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateEstimate_optional.xml", parametersMap);
   ...
   public void testUpdateTaxWithOptionalParameters() throws Exception {
      ...
      String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
      RestResponse<OMElement> apiRestResponse =
            sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_updateTax_optional.xml", parametersMap);
   ...
   public void testListTaxWithMandatoryParameters() throws Exception {
      ...
      Assert.assertEquals(
            getValueByExpression("string(//*[local-name()='response']/@status)", esbRestResponse.getBody()), "ok");
      Assert.assertEquals(getValueByExpression("string(//*[local-name()='taxes']/@total)", esbRestResponse.getBody()),
   ...
   public void testListTaxWithOptionalParameters() throws Exception {
      ...
      Assert.assertEquals(getValueByExpression("string(//*[local-name()='taxes']/@total)", esbRestResponse.getBody()),
            getValueByExpression("string(//*[local-name()='taxes']/@total)", apiRestResponse.getBody()));
      Assert.assertEquals(
            getValueByExpression("//*[local-name()='tax'][1]/*[local-name()='page']/text()", esbRestResponse.getBody()),
            getValueByExpression("//*[local-name()='tax'][1]/*[local-name()='page']/text()", apiRestResponse.getBody()));
      Assert.assertEquals(
   ...
   public void testDeleteTaxWithMandatoryParameters() throws Exception {
      ...
      String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
      RestResponse<OMElement> apiRestResponse =
            sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_deleteTax_mandatory.xml", parametersMap);
   ...
   public void testDeleteTaxNegativeCase() throws Exception {
      ...
      String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
      RestResponse<OMElement> apiRestResponse =
            sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_deleteTax_negative.xml", parametersMap);
   ...
   public void testGetReceiptWithMandatoryParameters() throws Exception {
      ...
      esbRequestHeadersMap.put("Content-Type", "application/xml");
      InputStream isEsb =
            processForInputStream(proxyUrl, "POST", esbRequestHeadersMap, "esb_getReceipt_mandatory.xml", parametersMap);
   ...
   public void testGetReceiptNegativeCase() throws Exception {
      ...
      String apiEndPoint = connectorProperties.getProperty("apiUrl") + API_URL_REMAINDER;
      RestResponse<OMElement> apiRestResponse =
            sendXmlRestRequest(apiEndPoint, "POST", apiRequestHeadersMap, "api_getReceipt_negative.xml", parametersMap);
   ...
   public void testDeleteReceiptWithMandatoryParameters() throws Exception {
      ...
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_deleteReceipt_mandatory.xml", parametersMap);
   ...
   public void testDeleteReceiptNegativeCase() throws Exception {
      ...
      esbRequestHeadersMap.put("Action", "urn:deleteReceipt");
      RestResponse<OMElement> esbRestResponse =
            sendXmlRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_deleteReceipt_negative.xml", parametersMap);
