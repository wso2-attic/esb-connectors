...
Steps to follow in setting integration test.
 ...
 4. Compress modified ESB as wso2esb-4.9.0-ALPHA.zip and copy that zip file in to location "{gotowebinar_connector_Home}/gotowebinar-connector/gotowebinar-connector-1.0.0/org.wso2.carbon.connector/repository/".
