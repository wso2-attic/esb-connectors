...
public class NestConnectorIntegrationTest extends ESBIntegrationTest {
    ...
    public void testViewCurrentTemperatureFahrenheit() throws Exception {
        ...
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceThermostats"), nestConnectorProperties.getProperty("deviceIdThermostat"), "viewCurrentTemperatureFahrenheit", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
    ...
    public void testViewTargetTemperatureFahrenheit() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceThermostats"), nestConnectorProperties.getProperty("deviceIdThermostat"), "viewTargetTemperatureFahrenheit", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewHumidity() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceThermostats"), nestConnectorProperties.getProperty("deviceIdThermostat"), "viewHumidity", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewTemperatureMode() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceThermostats"), nestConnectorProperties.getProperty("deviceIdThermostat"), "viewTemperatureMode", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewCOAlarmState() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceSmokeCOAlarms"), nestConnectorProperties.getProperty("smokeCOAlarmDeviceId"), "viewCOAlarmState", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewSmokeAlarmState() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, "viewSmokeAlarmState", nestConnectorProperties.getProperty("deviceSmokeCOAlarms"), nestConnectorProperties.getProperty("smokeCOAlarmDeviceId"), nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewBatteryHealth() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceSmokeCOAlarms"), nestConnectorProperties.getProperty("smokeCOAlarmDeviceId"), "viewBatteryHealth", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewManualTestState() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, "viewManualTestState", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewLastManualTestStatus() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceSmokeCOAlarms"), nestConnectorProperties.getProperty("smokeCOAlarmDeviceId"), "viewLastManualTestStatus", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewLastManualTestTimestamp() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceSmokeCOAlarms"), nestConnectorProperties.getProperty("smokeCOAlarmDeviceId"), "viewLastManualTestTimestamp", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewOnlineStatus() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceSmokeCOAlarms"), nestConnectorProperties.getProperty("smokeCOAlarmDeviceId"), "viewOnlineStatus", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewLastConnectionInformation() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceSmokeCOAlarms"), nestConnectorProperties.getProperty("smokeCOAlarmDeviceId"), "viewLastConnectionInformation", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testGetServicesForSmokeCOAlarmsNegativeCase() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("deviceSmokeCOAlarms"), nestConnectorProperties.getProperty("smokeCOAlarmDeviceIdInvalid"), "viewOnlineStatus", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            int responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
            Assert.assertTrue(responseHeader == 404);
        } finally {
    ...
    public void testViewAllThermostats() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("structureId"), "viewThermostats", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewAllSmokeCOAlarms() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("structureId"), "viewSmokeCOAlarms", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewEnergyEventPeekstart() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("structureId"), "viewEnergyEventPeekStart", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewAwayState() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("structureId"), "viewAwayState", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testViewPostalcode() throws Exception {
        ...
        String methodName = "nest_getServices";
        final String jsonString = ConnectorIntegrationUtil.getFileContent(jsonRequestFilePath);
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("structureId"), "viewPostalCode", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        try {
            String responseConnector = ConnectorIntegrationUtil.sendRequestString("POST", getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void testGetServicesForStructuresNegativeCase() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("structureIdInvalid"), "viewAwayState", nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            int responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
            Assert.assertTrue(responseHeader == 404);
        } finally {
    ...
    public void setFanTimer() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("fanTimerState"), nestConnectorProperties.getProperty("deviceIdThermostat"), nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            JSONObject responseConnector = ConnectorIntegrationUtil.sendRequest("POST", getProxyServiceURL(methodName), modifiedJsonString);
            JSONObject jo = new JSONObject(modifiedJsonString);
    ...
    public void setFanTimerNegative() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("fanTimerStateInvalid"), nestConnectorProperties.getProperty("deviceIdThermostat"), nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            int responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
    ...
    public void setTargetTemperature() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("targetTemperature"), nestConnectorProperties.getProperty("scale"), nestConnectorProperties.getProperty("deviceIdThermostat"), nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            JSONObject responseConnector = ConnectorIntegrationUtil.sendRequest("POST", getProxyServiceURL(methodName), modifiedJsonString);
            JSONObject jo = new JSONObject(modifiedJsonString);
    ...
    public void setTemperatureMode() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("temperatureMode"), nestConnectorProperties.getProperty("deviceIdThermostat"), nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            JSONObject responseConnector = ConnectorIntegrationUtil.sendRequest("POST", getProxyServiceURL(methodName), modifiedJsonString);
            JSONObject jo = new JSONObject(modifiedJsonString);
    ...
    public void setTemperatureModeNegative() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("temperatureModeInvalid"), nestConnectorProperties.getProperty("deviceIdThermostat"), nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            int responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
            Assert.assertTrue(responseHeader == 400);
        } finally {
     ...
     */
    @Test(groups = {"wso2.esb"}, priority = 2, description = "nest {setAwayState} integration test.")
    public void setAwayState() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("awayState"), nestConnectorProperties.getProperty("structureId"), nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            JSONObject responseConnector = ConnectorIntegrationUtil.sendRequest("POST", getProxyServiceURL(methodName), modifiedJsonString);
            JSONObject jo = new JSONObject(modifiedJsonString);
    ...
    public void setAwayStateNegative() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("awayStateInvalid"), nestConnectorProperties.getProperty("structureId"), nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            int responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
            Assert.assertTrue(responseHeader == 400);
        } finally {
    ...
    public void setETA() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("tripId"), nestConnectorProperties.getProperty("begin"), nestConnectorProperties.getProperty("end"), nestConnectorProperties.getProperty("structureId"), nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            JSONObject responseConnector = ConnectorIntegrationUtil.sendRequest("POST", getProxyServiceURL(methodName), modifiedJsonString);
            JSONObject jo = new JSONObject(modifiedJsonString);
            Assert.assertTrue((responseConnector.has("error") && responseConnector.getString("error").equals("Not in away mode")) || (responseConnector.getJSONObject("eta").getString("trip_id").equals(jo.getString("tripId").toString()) && jo.getString("estimated_arrival_window_begin").equals(jo.getString("begin").toString()) && jo.getString("estimated_arrival_window_end").equals(jo.getString("end").toString())));
        } finally {
            proxyAdmin.deleteProxy(methodName);
        }
    }
    ...
    public void setETANegative() throws Exception {
        ...
        final String proxyFilePath = "file:///" + pathToProxiesDirectory + methodName + ".xml";
        proxyAdmin.addProxyService(new DataHandler(new URL(proxyFilePath)));
        String modifiedJsonString = String.format(jsonString, nestConnectorProperties.getProperty("tripId"), nestConnectorProperties.getProperty("beginInvalid"), nestConnectorProperties.getProperty("end"), nestConnectorProperties.getProperty("structureId"), nestConnectorProperties.getProperty("clientId"), nestConnectorProperties.getProperty("clientSecret"), nestConnectorProperties.getProperty("code"), nestConnectorProperties.getProperty("apiRedirectUrl"));
        try {
            int responseHeader = ConnectorIntegrationUtil.sendRequestToRetriveHeaders(getProxyServiceURL(methodName), modifiedJsonString);
            Assert.assertTrue(responseHeader == 400);
        } finally {
