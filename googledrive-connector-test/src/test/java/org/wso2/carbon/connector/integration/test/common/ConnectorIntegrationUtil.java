...
public class ConnectorIntegrationUtil {
     ...
     */
    public static OperationClient buildMEPClientWithAttachment(EndpointReference endpoint, OMElement request,
     ...
     * @throws AxisFault on failure to initialize the client.
     */
    public static OperationClient buildMEPClient(EndpointReference endpoint, OMElement request) throws AxisFault {
