...
public class AcquiaContextDbConnectorIntegrationTest extends ESBIntegrationTest {
     ...
     */
    @Test(enabled=false, groups = {"wso2.esb"}, description = "AcquiaContextDb {getAllSegmants} integration test with positive case.")
     ...
     */
    @Test(enabled=false,groups = {"wso2.esb"}, description = "AcquiaContextDb {getVisitorQuery} ")
