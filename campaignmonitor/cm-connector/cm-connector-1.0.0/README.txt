...
Note:
	This test suite can be executed based on two scenarios.
		...
		2. Set up a new Campaign Monitor account and follow the instructions given in steps 5, 6.

STEPS:
 
 1. Download ESB 4.9.0-ALPHA by following the URL: https://svn.wso2.org/repos/wso2/scratch/ESB/

 2. Extract the certificate from browser by navigating to "https://www.campaignmonitor.com/" and place the certificate file in following locations.
 ...
 4. Make sure that the ESB 4.9.0-ALPHA zip file and the changes in step 1 and 2, is available at "{ESB_CONNECTORS_HOME}/repository/"
 ...
 11. Make sure that the campaignmonitor connector is set as a module in esb-connectors parent pom.
        <module>campaignmonitor/cm-connector/cm-connector-1.0.0/org.wso2.carbon.connector</module>

 12. Navigate to "<ESB_CONNECTORS_HOME>" and run the following command.
       $ mvn clean install
