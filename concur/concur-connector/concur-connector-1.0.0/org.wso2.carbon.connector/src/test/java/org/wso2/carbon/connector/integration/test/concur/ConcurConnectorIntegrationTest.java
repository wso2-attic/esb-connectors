...
public class ConcurConnectorIntegrationTest extends ConnectorIntegrationTestBase {
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateReceiptImageWithMandatoryParameters", "testDeleteReceiptImageWithMandatoryParameters" }, description = "Concur {createReceiptImage} integration test with mandatory parameters.")
     ...
     */
    @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateReceiptImageWithOptionalParameters","testDeleteReceiptImageWithOptionalParameters" }, description = "Concur {createReceiptImage} integration test negative case.")
