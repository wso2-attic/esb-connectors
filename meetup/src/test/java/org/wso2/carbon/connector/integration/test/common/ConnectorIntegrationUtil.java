...
public class ConnectorIntegrationUtil {
	...
	public static final String ESB_CONFIG_LOCATION =
			"artifacts" + File.separator + "ESB" + File.separator + "config";
	...
	public static int sendRequestToRetriveHeaders(String addUrl, String query)
	...
	public static JSONArray sendRequestJSONArray(String addUrl, String query)
			throws IOException, JSONException {
