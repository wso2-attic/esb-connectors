...
public class ConnectorIntegrationUtil {
	...
	public static void uploadConnector(String repoLocation,
		...
		uploadedFileItem.setDataHandler(new DataHandler(new URL("file:"
				+ File.separator + File.separator + repoLocation
	...
	public static Properties getConnectorConfigProperties(String connectorName) {
		...
		try {
			connectorConfigFile = ProductConstant.SYSTEM_TEST_SETTINGS_LOCATION
					...
					+ File.separator + connectorName + ".properties";
	...
	public static OMElement sendReceive(OMElement payload,
			String endPointReference, String operation, String contentType)
			throws AxisFault {
	...
	/**
	 * Method to read in contents of SOAP Request file as String
	 * 
	 * @param path
	 * @param encoding
	 ...
	 * @throws IOException
	 */
	public static String readSoapRequestFile(String path, Charset encoding)
			throws IOException {
