...
Steps to follow in setting integration test.
 ...
 3. Compress modified ESB as WSO2 ESB 4.9.0-ALPHA.zip and copy that zip file in to location "{ESB_Connector_Home}/repository/".
 ...
 5. Update the Simplenote properties file at location "{ESB_Connector_Home}/Simplenote/Simplenote-connector/Simplenote-connector-1.0.0/org.wso2.carbon.connector/src/test/resources/artifacts/ESB/connector/config" as below.
 ...
 6. Make sure that the Simplenote connector is set as a module in esb-connectors parent pom.
         <module>simplenote/simplenote-connector/simplenote-connector-1.0.0/org.wso2.carbon.connector</module>
