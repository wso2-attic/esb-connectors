...
STEPS:
 ...
 3. Update the Evernote properties file at location "{PATH_TO_SOURCE_BUNDLE}/dropbox-connector/dropbox-connector-1.0.0/src/test/resources/artifacts/ESB/connector/config" as below.
 ...
 NOTE : Following Evernote account, can be used for run the integration tests.
    ...
    developer token (SANDBOX) : S=s424:U=48524b0:E=14e531dc27f:C=146fb6c9600:P=1cd:A=en-devtoken:V=2:H=4a4e288787109ed314ebce861c5c2c92
    notestore url : https://www.evernote.com/shard/s424/notestore
    developer token type : (SANDBOX) 
