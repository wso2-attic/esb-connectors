...
public class ExpungeNotebook extends AbstractConnector {

    @Override
    public void connect(MessageContext messageContext) throws ConnectException {
        try {
            SynapseLog log = getLog(messageContext);
            log.auditLog("Start : expungeNotebook");
            ...
            int updateSequenceNumber = noteStoreClient.expungeNotebook(guid);

            OMElement omResponse = EvernoteUtil.parseResponse("notebook.expunge.success");
            ...
            log.auditLog("Stop: expungeNotebook");
        } catch (TException e) {
