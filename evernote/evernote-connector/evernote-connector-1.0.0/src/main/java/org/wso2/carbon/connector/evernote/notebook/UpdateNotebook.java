...
public class UpdateNotebook extends AbstractConnector {
    @Override
    public void connect(MessageContext messageContext) throws ConnectException {
        try {
            SynapseLog log = getLog(messageContext);
            log.auditLog("Start : updateNotebook");
            ...
            String newName = EvernoteUtil.lookupTemplateParamater(messageContext, EvernoteUtil.NOTEBOOK_NAME);
            ...
            int updateSequenceNumber = noteStoreClient.updateNotebook(notebook);

            OMElement omResponse = EvernoteUtil.parseResponse("notebook.update.success");
            ...
            log.auditLog("Stop : updateNotebook");
        } catch (TException e) {
