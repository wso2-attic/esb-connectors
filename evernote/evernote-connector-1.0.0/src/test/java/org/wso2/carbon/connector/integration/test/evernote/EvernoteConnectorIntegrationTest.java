...
public class EvernoteConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void testCreateNoteMandatoryParams() throws Exception {
        ...
        OMElement createNoteMandatoryParamRequest = AXIOMUtil.stringToOM(omString);
        OMElement response = evernoteServiceClient.sendReceive(createNoteMandatoryParamRequest, getProxyServiceURL("evernote"), "mediate");
