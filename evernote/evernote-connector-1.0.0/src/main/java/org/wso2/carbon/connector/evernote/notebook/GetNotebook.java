...
public class GetNotebook extends AbstractConnector {
    @Override
    public void connect(MessageContext messageContext) throws ConnectException {
        try {
            SynapseLog log = getLog(messageContext);
            log.auditLog("Start : getNotebook");
            ...
            OMElement omResponse = EvernoteUtil.parseResponse("notebook.display.success");
