...
02) Follow the below mentioned steps to create a new FreshDesk account:
    ...
    v)   In your account dashboard: Go to Customers -> Companies and Create a new company (The company name should not contain any spaces in between). Save the Company name for further use.
