...
public class FreshdeskConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(priority = 1, dependsOnMethods = { "testCreateTicketWithMandatoryParameters" },
            description = "FreshDesk {updateTicket} integration test with optional parameters.")
    ...
    public void testAssignTicketWithMandatoryParameters() throws IOException, JSONException {
        ...
        Assert.assertTrue(apiRestResponseGetTicket.getBody().getJSONObject("helpdesk_ticket")
                .getString("responder_id").equals("null"));
        ...
        RestResponse<JSONObject> apiRestResponseGetUser =
                sendJsonRestRequest(apiUrlGetUser, "GET", apiRequestHeadersMap);
    ...
    public void testListUsersWithMandatoryParameters() throws IOException, JSONException {
        ...
        // response.
        if (length > 0) {
            Assert.assertEquals(esbResponseArray.getJSONObject(0).getJSONObject("user").getString("id"),
                    apiResponseArray.getJSONObject(0).getJSONObject("user").getString("id"));
     ...
     * @throws IOException
     */
    @Test(priority = 1, dependsOnMethods = { "testCreateTicketWithOptionalParameters" },
            description = "FreshDesk {addNote} integration test with optional parameters.")
