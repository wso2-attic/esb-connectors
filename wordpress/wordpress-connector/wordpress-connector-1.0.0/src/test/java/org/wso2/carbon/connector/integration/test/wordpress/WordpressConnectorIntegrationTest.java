...
public class WordpressConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    public void testGetBlogUsersWithManditoryParameters() throws Exception {
    ...
    public void testGetTagsWithManditoryParameters() throws Exception {
     ...
     */
    @Test(dependsOnMethods = {"testGetTagsWithManditoryParameters","testGetTagsWithOptionalParameters"}, groups = { "wso2.esb" }, description = "wordpress {deleteTag} integration test.")
     ...
     */
    @Test(priority = 2, groups = { "wso2.esb" }, description = "wordpress {deleteTag} integration test.")
